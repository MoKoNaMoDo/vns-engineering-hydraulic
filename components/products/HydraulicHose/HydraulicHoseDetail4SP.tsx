...
const specData = [
  ...
  { dn: 10, inch: "3/8", size: -6, id: 9.5, braid: 17.5, od: 21.4, opBar: 445, opPsi: 6450, test: 890, burst: 1780, bending: 180, weight: 0.780 },
  { dn: 12, inch: "1/2", size: -8, id: 12.7, braid: 20.2, od: 24.6, opBar: 415, opPsi: 6000, test: 830, burst: 1660, bending: 230, weight: 0.930 },
  { dn: 16, inch: "5/8", size: -10, id: 15.9, braid: 23.8, od: 28.2, opBar: 350, opPsi: 5075, test: 700, burst: 1400, bending: 250, weight: 1.130 },
  { dn: 19, inch: "3/4", size: -12, id: 19.0, braid: 28.2, od: 32.2, opBar: 350, opPsi: 5075, test: 700, burst: 1400, bending: 300, weight: 1.530 },
  { dn: 25, inch: "1", size: -16, id: 25.4, braid: 35.3, od: 39.7, opBar: 280, opPsi: 4060, test: 560, burst: 1120, bending: 340, weight: 2.060 },
  { dn: 31, inch: "1 1/4", size: -20, id: 31.8, braid: 46.0, od: 50.8, opBar: 210, opPsi: 3050, test: 420, burst: 840, bending: 460, weight: 3.290 },
  { dn: 38, inch: "1 1/2", size: -24, id: 38.1, braid: 52.4, od: 57.2, opBar: 185, opPsi: 2680, test: 370, burst: 740, bending: 560, weight: 3.680 },
  { dn: 51, inch: "2", size: -32, id: 50.8, braid: 65.3, od: 69.8, opBar: 165, opPsi: 2390, test: 330, burst: 660, bending: 660, weight: 5.170 },
];

export default function HydraulicHoseDetail4SP() {
        ...
        <div className="grid gap-10 lg:grid-cols-2 items-start mb-16">
          ...
          <div className="flex flex-col items-center lg:items-start animate-slide-left">
            <div className="relative w-full max-w-[480px] mx-auto lg:mx-0">
              ...
              <div className="relative aspect-square overflow-hidden rounded-3xl border-2 border-[#af0000] p-1 shadow-[0_20px_50px_rgba(0,0,0,0.2)] bg-white">
                <div className="relative h-full w-full overflow-hidden rounded-[1.4rem]">
                  <Image
                    src="/products/products/Hydralic Hose4.png"
            ...
            <div className="mt-4 flex justify-center w-full max-w-[480px]">
              <div className="bg-[#3b6db4] px-8 py-3 text-xl font-black text-white shadow-lg block text-center">{t('badge4SP')}</div>
            </div>
          </div>
          ...
          <div className="pt-4 lg:pt-0 animate-slide-right">
            ...
            {/* Tags Section */}
            <ProductTags tags={["HYDRAULIC HOSE", "สายไฮดรอลิค", "4SP", "DIN EN 856", "สายแรงดันสูง", "สายน้ำมันไฮดรอลิค"]} categoryHref="/products/hydraulic-hose" />
          </div>
        </div>
          ...
          <table className="w-full min-w-[1000px] text-center border-collapse">
            <thead>
              <tr className="bg-[#af0000] text-white">
                ...
                <th className="py-4 px-2 border-r border-white/20" rowSpan={2}>Braid Ø<br /><span className="text-xs font-normal">mm</span></th>
            ...
            <tbody>
              {specData.map((row, idx) => (
                <tr key={idx} className={`${idx % 2 === 0 ? 'bg-white' : 'bg-zinc-50'} hover:bg-red-50 transition-colors`}>
                  ...
                  <td className="py-4 font-bold border-r border-zinc-200">{row.braid.toFixed(1)}</td>
