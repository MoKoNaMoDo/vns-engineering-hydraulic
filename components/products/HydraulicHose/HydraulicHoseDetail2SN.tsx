        ...
        <div className="grid gap-10 lg:grid-cols-2 items-start mb-16">
          ...
          <div className="flex flex-col items-center lg:items-start animate-slide-left">
            ...
            <div className="mt-4 flex justify-center w-full max-w-[480px]">
              <Link href="/products/hydraulic-hose" className="bg-[#3b6db4] px-8 py-3 text-xl font-black text-white shadow-lg transition-all duration-300 hover:bg-[#af0000] hover:scale-105 cursor-pointer block text-center">สายไฮดรอลิก 2SN (High Pressure)</Link>
            </div>
          </div>
