...
const specData = [
  { dn: 19, inch: "3/4", size: -12, id: 19.0, braid: 28.4, od: 32.2, opBar: 420, opPsi: 6090, test: 840, burst: 1680, bending: 280, weight: 1.530 },
  { dn: 25, inch: "1", size: -16, id: 25.4, braid: 35.2, od: 38.7, opBar: 380, opPsi: 5500, test: 760, burst: 1520, bending: 340, weight: 2.120 },
  { dn: 31, inch: "1 1/4", size: -20, id: 31.8, braid: 41.9, od: 45.5, opBar: 325, opPsi: 4700, test: 650, burst: 1300, bending: 460, weight: 2.580 },
  { dn: 38, inch: "1 1/2", size: -24, id: 38.1, braid: 48.8, od: 53.5, opBar: 290, opPsi: 4200, test: 580, burst: 1160, bending: 560, weight: 3.460 },
  { dn: 51, inch: "2", size: -32, id: 50.8, braid: 63.1, od: 68.1, opBar: 250, opPsi: 3625, test: 500, burst: 1000, bending: 700, weight: 4.920 },
];

export default function HydraulicHoseDetail4SH() {
  return (
        ...
        <div className="grid gap-10 lg:grid-cols-2 items-start mb-16">
          ...
          <div className="flex flex-col items-center lg:items-start animate-slide-left">
            ...
            <div className="mt-4 flex justify-center w-full max-w-[480px]">
              <Link href="/products/hydraulic-hose" className="bg-[#3b6db4] px-8 py-3 text-xl font-black text-white shadow-lg transition-all duration-300 hover:bg-[#af0000] hover:scale-105 cursor-pointer block text-center">สายไฮดรอลิก 4SH (Super High)</Link>
            </div>
          </div>
          ...
          <div className="pt-4 lg:pt-0 animate-slide-right">
            ...
            <ul className="space-y-4 text-lg font-bold text-zinc-700">
              ...
              <li className="flex items-start gap-3">
                <span className="mt-2 h-2 w-2 shrink-0 rounded-full bg-[#af0000]" />
                เสริมแรงด้วยลวดเหล็กกล้าถัก 4 ชั้นแบบพันเกลียว (4 Heavy Spiral layers) เพื่อทนแรงดันสูงพิเศษ
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-2 h-2 w-2 shrink-0 rounded-full bg-[#af0000]" />
            ...
            {/* Tags Section */}
            <ProductTags tags={["HYDRAULIC HOSE", "สายไฮดรอลิค", "4SH", "DIN EN 856", "สายแรงดันสูงพิเศษ", "สายน้ำมันไฮดรอลิค"]} categoryHref="/products/hydraulic-hose" />
          </div>
        </div>
